...
Hay una librería dedicada al manejo _bonito_ de las listas, que posiblemente vamos a ver más adelante en el curso.
...
```{r,echo=FALSE}
mi_matriz4 <- matrix(c(1.7,6,12,6,781.05,15,101,-140,-0.05,750),byrow = TRUE,ncol = 5)
mi_matriz4
```
...
<!----matrix(c(1.7,6,12,6,781.05,15,101,-140,-0.05,750),byrow = TRUE,ncol = 6) -->
