...
Muchas veces se quieren trabajar de forma vectorial los condicionales. Por lo que lo programaron de forma vectorial.

```{r}
d <- ifelse(1:15 < 10, 5, 3)
```
...
Si se intenta el llamado anterior con un `if`, da un error:
